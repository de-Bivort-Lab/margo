...
%       presentations, and are not already being presented with a stimulus
    ...
    trackDat.StimStatus(activate_stim) = true;                             
    ...
    if any(trackDat.StimStatus)
        ...
        p_cen(:,1) = ...
            expmt.hardware.projector.Fx(...
                trackDat.centroid(trackDat.StimStatus,1),...
        ...
        p_cen(:,2) = ...
            expmt.hardware.projector.Fy(...
                ...
                trackDat.centroid(trackDat.StimStatus,2));
        p_dist = ...
            [p_cen(:,1) - stim.centers(trackDat.StimStatus,1),...
            p_cen(:,2) - stim.centers(trackDat.StimStatus,2)];
        p_dist = p_dist .* stim.scale(trackDat.StimStatus,:);
        src_rects = NaN(size(stim.corners(trackDat.StimStatus,:)));
        ...
        if any(~trackDat.Texture(trackDat.StimStatus))
            ...
            Screen('DrawTextures', expmt.hardware.screen.window, ...
                stim.pinTex_neg,...
                src_rects(~trackDat.Texture(trackDat.StimStatus),:)', ...
                stim.corners(trackDat.StimStatus & ...
                ~trackDat.Texture,:)', [],[], [], [],[], []);
        end
