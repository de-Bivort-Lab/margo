...
if isfield(p,'ramp_time')
    set(handles.edit_ramp,'string',num2str(p.ramp_time));
end
...
rt = str2double(handles.edit_ramp.String);
pmin = 0;
pmax = 10;
n = 1000;
r = repmat(1:255,n,1);
...
handles.circ_fig.Position(2) = gui_fig.Position(2) + ...
    sum(light_uipanel.Position([2 4])) - handles.circ_fig.Position(4)*1.05;
