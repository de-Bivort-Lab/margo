function expmt = run_tempphototaxis(expmt,gui_handles,varargin)
%
...
trackDat.fields={'centroid';'orientation';'time';'LightStatus'};
...
trackDat.StimAngle = round(rand(nROIs,1).*360);
