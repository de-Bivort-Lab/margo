...
% Will be replaced by filterVignetting once ROIs are detected
gauss_im=buildGaussianKernel(size(ROI_image,2),size(ROI_image,1),sigma,kernelWeight);
ROI_image=(uint8(double(ROI_image).*gauss_im));
