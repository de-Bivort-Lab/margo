...
udat = handles.gui_fig.UserData;
udat.speed_thresh = old.parameters.speed_thresh;
udat.distance_thresh = old.parameters.distance_thresh;
udat.vignette_sigma = old.parameters.vignette_sigma ;
udat.vignette_weight = old.parameters.vignette_weight;
udat.area_min = old.parameters.area_min;
udat.area_max = old.parameters.area_max;
udat.area_max = old.parameters.area_max;
udat.ROI_mode = old.parameters.ROI_mode;
udat.sort_mode = old.parameters.sort_mode;
udat.ROI_tol = old.parameters.ROI_tol;
udat.target_rate = ...
    old.parameters.target_rate;
handles.edit_ref_depth.Value = ...
    old.parameters.ref_depth;
handles.edit_ref_depth.String = ...
    num2str(old.parameters.ref_depth);
handles.edit_ref_freq.Value = ...
    old.parameters.ref_freq;
handles.edit_ref_freq.String = ...
    num2str(old.parameters.ref_freq);
handles.edit_exp_duration.Value = ...
    old.parameters.duration;
handles.edit_exp_duration.String = ...
    num2str(old.parameters.duration);
handles.ROI_thresh_slider.Value = ...
    old.parameters.ROI_thresh;
handles.disp_ROI_thresh.String = ...
    num2str(round(old.parameters.ROI_thresh));
handles.track_thresh_slider.Value = ...
    old.parameters.track_thresh;
handles.disp_track_thresh.String = ...
    num2str(round(old.parameters.track_thresh));
...
old = reset(old);                   % remove fields that must be re-defined each expmt
