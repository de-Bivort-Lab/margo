...
% --------------------------------------------------------------------
function saved_presets_menu_Callback(hObject,~,handles)
% hObject    handle to saved_presets_menu (see GCBO)

gui_fig = handles.gui_fig;     % get gui handles
...
if ~exist('expmt','var')
    errordlg('Selected file does not contain an ExperimentData object');
    return
end
...
% --- Executes on button press in _pushbutton.
